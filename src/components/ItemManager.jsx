    ...
    <div>
      ...
      <div style={{
        ...
        {["rectangular", "circular"].map((s) => (
          <button key={s} onClick={() => onChange("shape", s)} style={{
      ...
      <div className="form-grid">
        ...
        <DiaSelect label={isCircular ? "Spiral/Tie Dia" : "Lateral Tie Dia"} value={item.tieDia} onChange={u("tieDia")} />
        <MMF label={isCircular ? "Spiral Pitch" : "Tie Spacing"} value={item.tieSpacing} onChange={u("tieSpacing")} />
      </div>
    </div>
  );
}
